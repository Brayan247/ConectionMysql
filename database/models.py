...
class Administrador(models.Model):
    ...
    idadministrador = models.AutoField(
        db_column='idAdministrador', primary_key=True)
    # Field name made lowercase.
    idaplicativo = models.IntegerField(
        db_column='idAplicativo', blank=True, null=True)
    ...
    # Field name made lowercase.
    idpais = models.IntegerField(db_column='idPais', blank=True, null=True)
    ...
    # Field name made lowercase.
    idadministradorregistro = models.IntegerField(
        db_column='idAdministradorRegistro', blank=True, null=True)
    # Field name made lowercase.
    idadministradoredito = models.IntegerField(
        db_column='idAdministradorEdito', blank=True, null=True)
    # Field name made lowercase.
    bloqueadomensaje = models.CharField(
        db_column='bloqueadoMensaje', max_length=400, blank=True, null=True)
    ...
    # Field name made lowercase.
    mensajereactivacion = models.CharField(
        db_column='mensajeReactivacion', max_length=400, blank=True, null=True)
    # Field name made lowercase.
    tiposangre = models.CharField(
        db_column='tipoSangre', max_length=6, blank=True, null=True)
    # Field name made lowercase.
    cambiarclave = models.IntegerField(
        db_column='cambiarClave', blank=True, null=True)
    # Field name made lowercase.
    clavetemporal = models.CharField(
        db_column='claveTemporal', max_length=5, blank=True, null=True)
    ...
    idtipoidentificacion = models.IntegerField(
        db_column='idTipoIdentificacion', blank=True, null=True)
...
class CamposPersonalizadosEntidad(models.Model):
    # Field name made lowercase.
    entidad_identidad = models.OneToOneField(
        'Entidad', models.DO_NOTHING, db_column='entidad_idEntidad', primary_key=True)
    campos_personalizados_nueva_cuenta_idcampo = models.ForeignKey(
        'CamposPersonalizadosNuevaCuenta', models.DO_NOTHING, db_column='campos_personalizados_nueva_cuenta_idCampo')  # Field name made lowercase.
    ...
    class Meta:
        ...
        unique_together = (
            ('entidad_identidad', 'campos_personalizados_nueva_cuenta_idcampo'),)


class CamposPersonalizadosNuevaCuenta(models.Model):
    # Field name made lowercase.
    idcampo = models.AutoField(db_column='idCampo', primary_key=True)
    ...
    tipo = models.ForeignKey(
        'TiposCampos', models.DO_NOTHING, db_column='tipo')
...
class Canal(models.Model):
    # Field name made lowercase.
    idcanal = models.AutoField(db_column='idCanal', primary_key=True)
    ...
    tipo_canal = models.ForeignKey(
        'TipoCanal', models.DO_NOTHING, db_column='tipo_canal')
    id_entidad = models.ForeignKey(
        'Entidad', models.DO_NOTHING, db_column='id_entidad')
...
class Ciudad(models.Model):
    ...
    ciudad = models.CharField(unique=True, max_length=45,
    ...
    # Field name made lowercase.
    zonahoraria = models.CharField(
        db_column='zonaHoraria', max_length=6, blank=True, null=True)
    type = models.CharField(max_length=100)
    id_padre = models.IntegerField()
    # Field name made lowercase.
    pais_idpais = models.ForeignKey(
        'Pais', models.DO_NOTHING, db_column='pais_idPais')
...
class ClienteBotHasEntidad(models.Model):
    # Field name made lowercase.
    cliente_bot_idcliente = models.OneToOneField(
        ClienteBot, models.DO_NOTHING, db_column='cliente_bot_idCliente', primary_key=True)
    # Field name made lowercase.
    entidad_identidad = models.ForeignKey(
        'Entidad', models.DO_NOTHING, db_column='entidad_idEntidad')
    eliminado = models.IntegerField()
...
class ConfigRecurso(models.Model):
    ...
    eliminado = models.IntegerField()
    id_recurso_entidad = models.ForeignKey(
        'RecursosEntidad', models.DO_NOTHING, db_column='id_recurso_entidad')
...
class Contrato(models.Model):
    # Field name made lowercase.
    idcontrato = models.AutoField(db_column='idContrato', primary_key=True)
...
class DetallePlan(models.Model):
    # Field name made lowercase.
    plan_idplan = models.OneToOneField(
        'Plan', models.DO_NOTHING, db_column='plan_idPlan', primary_key=True)
    # Field name made lowercase.
...
class Emoticon(models.Model):
    # Field name made lowercase.
    idemoticon = models.AutoField(db_column='idEmoticon', primary_key=True)
    ...
    identidad = models.ForeignKey(
        'Entidad', models.DO_NOTHING, db_column='idEntidad')
...
class Entidad(models.Model):
    ...
    eliminado = models.IntegerField()
    # Field name made lowercase.
    ciudad_idciudad = models.ForeignKey(
        Ciudad, models.DO_NOTHING, db_column='ciudad_idCiudad')
...
class Intencion(models.Model):
    # Field name made lowercase.
    idintencion = models.AutoField(db_column='idIntencion', primary_key=True)
    ...
    mensajedialogflow = models.TextField(
        db_column='mensajeDialogflow', blank=True, null=True)
    eliminado = models.IntegerField()
    fecha_registro = models.DateTimeField()
    fecha_actualizacion = models.DateTimeField()
    # Field name made lowercase.
...
class IntencionTipo(models.Model):
    # Field name made lowercase.
    idtipointencion = models.AutoField(
        db_column='idTipoIntencion', primary_key=True)
...
class ListaNegra(models.Model):
    ...
    id_recursos_entidad = models.ForeignKey(
        'RecursosEntidad', models.DO_NOTHING, db_column='id_recursos_entidad')
...
class LogsSystemFintech(models.Model):
    ...
    tipo = models.CharField(max_length=45)
    # Field name made lowercase.
    idadministrador = models.CharField(
        db_column='idAdministrador', max_length=45)
    fecha_registro = models.DateTimeField()
    fecha_actualizacion = models.DateTimeField(blank=True, null=True)
...
class Modulo(models.Model):
    # Field name made lowercase.
    idmodulo = models.IntegerField(db_column='idModulo', primary_key=True)
    ...
    # Field name made lowercase.
    idadministradorregistro = models.IntegerField(
        db_column='idAdministradorRegistro')
    # Field name made lowercase.
    idadministradoractualizo = models.IntegerField(
        db_column='idAdministradorActualizo', blank=True, null=True)
    fecha_registro = models.DateTimeField()
    eliminado = models.IntegerField()
    fecha_actualizacion = models.DateTimeField(blank=True, null=True)
...
class Pagina(models.Model):
    # Field name made lowercase.
    idpagina = models.AutoField(db_column='idPagina', primary_key=True)
    # Field name made lowercase.
    identidad = models.IntegerField(db_column='idEntidad')
    nombre = models.CharField(max_length=45)
    ...
    # Field name made lowercase.
    versionfacebook = models.CharField(
        db_column='versionFacebook', max_length=3)
    eliminado = models.IntegerField()
    fecha_registro = models.DateTimeField()
    fecha_actualizacion = models.DateTimeField()
...
class Pais(models.Model):
    ...
    # Field name made lowercase.
    codigoarea = models.CharField(
        db_column='codigoArea', unique=True, max_length=5)
    latitud = models.FloatField()
    longitud = models.FloatField()
    # Field name made lowercase.
    idadministradorregistro = models.IntegerField(
...
class PerfilAdministrador(models.Model):
    ...
    idadministradorregistro = models.IntegerField(
        db_column='idAdministradorRegistro')
    # Field name made lowercase.
    idadministradorhabilito = models.IntegerField(
        db_column='idAdministradorHabilito', blank=True, null=True)
    idadministradordeshabilito = models.IntegerField(
        db_column='idAdministradorDeshabilito', blank=True, null=True)  # Field name made lowercase.
...
class Plan(models.Model):
    # Field name made lowercase.
    idplan = models.AutoField(db_column='idPlan', primary_key=True)
    nombre = models.CharField(max_length=45)
    acronimo = models.CharField(max_length=45)
...
class PlanContrato(models.Model):
    # Field name made lowercase.
    plan_idplan = models.IntegerField(
        db_column='plan_idPlan', primary_key=True)
    # Field name made lowercase.
    contrato_idcontrato = models.IntegerField(db_column='contrato_idContrato')
    # Field name made lowercase.
    contrato_entidad_identidad = models.IntegerField(
        db_column='contrato_entidad_idEntidad')

    class Meta:
        managed = False
        db_table = 'plan_contrato'
        unique_together = (
            ('plan_idplan', 'contrato_idcontrato', 'contrato_entidad_identidad'),)


class RecursosEntidad(models.Model):
    # Field name made lowercase.
    idrecursos = models.AutoField(db_column='idRecursos', primary_key=True)
    path = models.CharField(max_length=45)
    tipo = models.CharField(max_length=45)
    param_entrada = models.TextField(
        db_collation='utf8mb4_bin', blank=True, null=True)
    param_salida = models.TextField(
        db_collation='utf8mb4_bin', blank=True, null=True)
    fecha_actualizacion = models.DateTimeField(blank=True, null=True)
    fecha_registro = models.DateTimeField()
    eliminado = models.IntegerField()
...
class TerminosCondiciones(models.Model):
    # Field name made lowercase.
    idtermino = models.AutoField(db_column='idTermino', primary_key=True)
...
class TipoCanal(models.Model):
    # Field name made lowercase.
    idtipocanal = models.AutoField(db_column='idTipoCanal', primary_key=True)
    nombre = models.CharField(max_length=55)
